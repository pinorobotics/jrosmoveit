 ...
 * 
 * Generated for ROS msg file: moveit_msgs/Constraints
 */
...
public class ConstraintsMessage implements Message {
   ...
   public ConstraintsMessage withPositionConstraints(PositionConstraintMessage... position_constraints) {
       this.position_constraints = position_constraints;
       return this;
   }
   
   public ConstraintsMessage withOrientationConstraints(OrientationConstraintMessage... orientation_constraints) {
       this.orientation_constraints = orientation_constraints;
       return this;
   }
   
   public ConstraintsMessage withVisibilityConstraints(VisibilityConstraintMessage... visibility_constraints) {

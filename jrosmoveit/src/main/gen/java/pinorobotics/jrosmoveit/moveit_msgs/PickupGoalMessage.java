...
/**
 * Definition for moveit_msgs/PickupGoal ====== DO NOT MODIFY! AUTOGENERATED FROM AN ACTION
...
public class PickupGoalMessage implements Message {
    ...
    /**
     * the name that the support surface (e.g. table) has in the collision map can be left empty if
     ...
     * move from pre-grasp to grasp and during lift. Collisions when moving to the pre-grasp
     * location are still not allowed even if this is set to true.
     */
    public boolean allow_gripper_support_collision;

    /**
     * The names of the links the object to be attached is allowed to touch; If this is left empty,
     * it defaults to the links in the used end-effector
     */
    public StringMessage[] attached_object_touch_links = new StringMessage[0];

    /**
     * Optionally notify the pick action that it should approach the object further, as much as
     * possible (this minimizing the distance to the object before the grasp) along the approach
     * direction; Note: this option changes the grasping poses supplied in possible_grasps[] such
     * that they are closer to the object when possible.
     */
     ...
     * touched/pushed/moved in the course of grasping; CAREFUL: If the object name 'all' is used,
     * collisions with all objects are disabled during the approach and lift.
     */
    ...
    public PickupGoalMessage withAllowGripperSupportCollision(
            boolean allow_gripper_support_collision) {
        this.allow_gripper_support_collision = allow_gripper_support_collision;
        return this;
    }

    public PickupGoalMessage withAttachedObjectTouchLinks(
            StringMessage... attached_object_touch_links) {
    ...
    public boolean equals(Object obj) {
        ...
        return Objects.equals(target_name, other.target_name)

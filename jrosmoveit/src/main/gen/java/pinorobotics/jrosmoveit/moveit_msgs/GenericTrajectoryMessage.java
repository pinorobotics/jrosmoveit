 ...
 * 
 * Generated for ROS msg file: moveit_msgs/GenericTrajectory
 */
 ...
 */
@MessageMetadata(
    type = GenericTrajectoryMessage.NAME,
...
public class GenericTrajectoryMessage implements Message {
   ...
   public GenericTrajectoryMessage withJointTrajectory(JointTrajectoryMessage... joint_trajectory) {
       this.joint_trajectory = joint_trajectory;
       return this;
   }
   
   public GenericTrajectoryMessage withCartesianTrajectory(CartesianTrajectoryMessage... cartesian_trajectory) {
   ...
   public int hashCode() {
       return Objects.hash(
           header,
           Arrays.hashCode(joint_trajectory),
           Arrays.hashCode(cartesian_trajectory)
       );
   }

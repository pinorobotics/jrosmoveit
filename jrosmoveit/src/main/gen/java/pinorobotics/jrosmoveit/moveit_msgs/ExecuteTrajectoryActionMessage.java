 ...
 * 
 * Generated for ROS msg file: moveit_msgs/ExecuteTrajectoryAction
 */
 ...
 */
@MessageMetadata(
    type = ExecuteTrajectoryActionMessage.NAME,
...
public class ExecuteTrajectoryActionMessage implements Message {
   ...
   public ExecuteTrajectoryActionMessage withActionGoal(ExecuteTrajectoryActionGoalMessage action_goal) {
       this.action_goal = action_goal;
       return this;
   }
   
   public ExecuteTrajectoryActionMessage withActionResult(ExecuteTrajectoryActionResultMessage action_result) {
